...
testbench_results_filenames.append("coincidence_detector_neuron_tb_input_spikes.txt")
# Then, we add the output spikes to the testbench results file list (index 1)
testbench_results_filenames.append("coincidence_detector_neuron_tb_output_spikes.txt")
