% Typical parameters:
%   -Sine: sample_freq = 96e3; duration = 0.5; amplitude = 1000;
%          freq = 1000; withNoise = 0;
%   -Chirp: sample_freq = 1e6; duration = 1; start_freq = 1; 
%          end_freq = 100;

% Output file parameters
output_left_filename = 'sin_96e3fs_0_5d_1000a_500Hz_left.bin';
output_right_filename = 'sin_96e3fs_0_5d_1000a_500Hz_right.bin';

% Signal parameters
signal_type = 0; % 0--> Sine; 1--> Chirp
signal_sample_freq = 96e3; % In Hz
...
fwrite(output_left_filehandler,generated_signal_left,'int16');
fclose(output_left_filehandler);

fwrite(output_right_filehandler,generated_signal_right,'int16');
